...
Original file is located at
    https://colab.research.google.com/drive/1aB5nrzol2wjtow-istDD8N1sMzFcK51X
"""
...
!pip install tensorflow==2.15.0  # Using a stable TF version
...
# Set paths
TILE_PATH = '/content/drive/MyDrive/train/output'
GEOJSON_PATH = '/content/drive/MyDrive/train/TOtraininglabel.geojson'
MODEL_PATH = '/content/drive/MyDrive/unet_model.h5'

# Verify paths exist
print("Checking paths...")
print(f"Tile directory exists: {os.path.exists(TILE_PATH)}")
print(f"GeoJSON file exists: {os.path.exists(GEOJSON_PATH)}")
...
# Function to load and preprocess a specific tile
...
# Load ground truth for a specific tile from GeoJSON
